...
struct ContainerMetricsEntry: Identifiable, Hashable, Sendable {
    let id: String
...
struct ContainerMetricsHistoryPoint: Identifiable, Hashable, Sendable {
    let capturedAt: Date
    let totalCPUUsagePercent: Double
    let totalMemoryUsageBytes: Int64
    let totalMemoryLimitBytes: Int64
...
enum CommandCapabilityStatus: String, Codable, Sendable {
    case unknown
    case available
    case unavailable
    ...
    var displayName: String {
        ...
        case .available: "Available in installed CLI"
        case .unavailable: "Not available"
        }
    }
}

struct CommandCapabilitySnapshot: Codable, Equatable, Sendable {
    var build: CommandCapabilityStatus = .unknown
    var machine: CommandCapabilityStatus = .unknown
    var checkedAt: Date?
}
